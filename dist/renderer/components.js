...
// ─── Drawing primitives ───
export function drawRoundedRect(ctx, x, y, w, h, radius, fill, stroke) {
    ctx.beginPath();
...
// ─── Header ───
export function drawHeader(ctx, theme, x, y, username, periodLabel) {
    // Title — large, primary
...
export function drawStatBlock(ctx, theme, x, y, label, value, options) {
...
export function drawStatGrid(ctx, theme, x, y, stats, options) {
    const compact = options?.compact ?? false;
    ...
    stats.forEach((stat, i) => {
        ...
        drawStatBlock(ctx, theme, x + col * colWidth, y + row * rowHeight, stat.label, stat.value, { compact });
    });
}
// ─── Section title helper ───
export function drawSectionTitle(ctx, theme, x, y, text) {
    ctx.fillStyle = theme.text.secondary;
...
// ─── Model ranking list ───
export function drawModelRanking(ctx, theme, x, y, models) {
...
export function drawHourlyChart(ctx, theme, x, y, w, h, distribution) {
...
export function drawFeatureColumns(ctx, theme, x, y, w, columns) {
...
// ─── Footer ───
export function drawFooter(ctx, theme, x, y, w) {
    // Divider line
